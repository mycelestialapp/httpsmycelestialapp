    ...
    <div className="max-w-md mx-auto space-y-6 pt-2 page-transition">
      ...
      <div className="text-center space-y-2">
        <motion.div
          ...
          style={{
            background: 'radial-gradient(circle, hsla(var(--gold) / 0.3), hsla(var(--gold) / 0.05))',
            boxShadow: '0 0 40px hsla(var(--gold) / 0.2)',
          }}
        >
      ...
      <div className="space-y-3">
        {PLANS.map(({ key, price, period, icon: Icon, features, popular }, i) => (
          ...
          >
            {popular && (
              <div
                className="absolute top-0 right-0 text-[9px] font-bold uppercase tracking-wider px-3 py-0.5 rounded-bl-xl"
                style={{
            ...
            <div
              className="glass-card-highlight p-5 transition-all"
              style={{
      ...
      {/* Subscribe CTA */}
      <button
        className="w-full py-3.5 rounded-2xl text-sm font-bold tracking-wide transition-all active:scale-[0.98]"
        style={{
          background: selectedPlan
            ? 'linear-gradient(135deg, hsl(var(--gold)), hsla(var(--gold) / 0.7))'
            : 'hsla(var(--muted) / 0.4)',
